...
if __name__ == "__main__":
	...
	senter = enter.get()
        ...
        canvas.update()
        os.system('export DISPLAY='+IP+':0;xdotool mousemove '+str(event.x)+' '+str(event.y)+' click 1;xdotool type '+txt)
	if senter == 1:
    ...
    b4 = Button(root, text="Open xterm", command=openxterm)
    b.pack(side='left')
    b4.pack(side='left')
    b2.pack(side='right')
    b3.pack()
