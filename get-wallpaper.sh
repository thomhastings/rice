...
gsettings set org.gnome.desktop.background picture-uri file:////~/Pictures/isometric_kali_dragon_by_xxdigipxx-dbyaw60.png
echo "Setting GNOME Lock Screen..."
gsettings set org.gnome.desktop.screensaver picture-uri file:////~/Pictures/isometric_kali_dragon_lockscreen_by_xxdigipxx-dbyaw8g.png
echo "Done!"
