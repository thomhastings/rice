#!/bin/sh
### run the poc || GTFO - int'l jrnl o' Run Ξ|TO 💩 || GTF0 ))
# Run the PoC, Volume 1, #1 RΞ|TO   # OSCP Cert Prep Links: ☭
# A companion for PoC||GTFO Ru.SH   # http://archive.is/5gO7c
#  ☭__Execute program code __ǝɥʇ __ # http://archive.is/2XVf3
#  |__)    _this  ___ _это|__)_ /   # http://archive.is/fQWqZ
#  | \ |_|| )__ Ξ) | (_)__|  (_)\__ # http://archive.is/tNXzF
#  Just run the PoC || GTFO already!# http://archive.is/cVmEK
#    ___            _____                ___       _____ 1of1
#   / _ \__ _____dis\__ /______ __      / _ \___  / ___/©2019
#  / , _/ // / _ \это/_ |_  __/ _ \ PoC/ ___/ _ \/ /__GNU AGPL
# /_/|_|\_,_/_//_/__/___/|__| \___/___/_/   \___/\___/CC-BY-SA
# Show the words "Public Domain" lower right every video frame.
#                         _______________
#                        / \             \
#                       /   \   Volume  1 \
#                      /     \  Issue   1  \
...
#   \                VIEW WITH MONOSPACE FONTS              /
# -~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-
#   PROJECT ALF-2                           a Planetary Effort
# -~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-
#           _     _.-,
#           \`-..' _/  仕事で上手になれ。
#           .'-''`   ) "Honey Badger don't give a fr@k."
#          /`'.   _ -'._
#         /__.:-'       `--..--."We own the night."
#             \      .  `  =  .:_    _.
# A-12 OXCART  \ .       `       `-.|  \  ~Starbuck
# (SR-71)   _.-'     '        '     |.'`',
#       _.-'    . '         '    .:'`    )
#    .-'    _='          .______/"'.  .'  `-.
#   /    _-'"     `    .'`     /  _:'``''--'`
...
#         .-" =/7"   _  .3#"=.                              <>
#       ,#7  " "  ,//)#d#######=.              .-"""-.      ||==================|
#     ,/ "      # ,i-/####MWA####=            /______=\     ||Pwn-WEST AUTHORITY|
#    /         _)#sm###=#=# ##4####           /      \-     ||     PRESENTS     |
#   /         (#/"_`;\//#=#\-#EVAR##\        ( ALF2.0 )|    ||   ALF ISSUE 2.0  |
#  /         ,d####-_.._.)##P########\        \______/=/    ||    WINTER 2021   |
# ,        ,"############\\##bi- `\| Y.       {_______}     ||==================|
# |       .d###FUCK#######b\##P'   V  |      /`*      `'--._||
# |\      '########THE######!",       |     /=.     [].`-.._{>
# |C.       \###=####RIAA####7        |    / /|nsa    |     ||
...
#              """"---""""                  _{___}_{___}    ||
#           50 YEAR ANNIVERSARY             (    )(    )    ||
#     JULY 1969: WE LANDED ON THE MOON!  ^^~ `"""  `""" ~^~~^^
# -~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-
#
...
#仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事
#
...
# -						     	    -
# ~  //A PLANETARY EFFORT:                                    ~
# -  !A sermon from Richard Thieme ........ security grandpa  -
# ~  !COOL LINKS .......................... 5tinger& friends  ~
# -						       	    -
# ~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#
# ~-INTRODUCTION-~
#
# FINALLY! A voice from the Pwnwest! It's been too long, hasn't
...
# Get back, put on your seat belts, and prepare for PWN!
#
# ~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#
# ~-CONTACT INFORMATION-~
...
# http://www.wallpapervortex.com/anime-neon_genesis_evangelion-wallpapers-page25.html
# http://kurousagi01.deviantart.com/art/Evangelion-Wallpaper-1680-1050-132096043
# 仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事仕事
# https://www.youtube.com/playlist?list=PLj8EOFaxOgsS63cd1YZjc56p2brTyIRUF
# https://www.youtube.com/playlist?list=PLoAx5AQlvczUPV87uLcxZmaAp7kYMI8JA
# https://www.youtube.com/playlist?list=PLp4w7b_XLssSa0I4z6-pz_z48e9am14fg
# https://www.youtube.com/playlist?list=PLnjNR4-S-EVqfJWovxEJyb7I0IOkKkoYM
# https://www.youtube.com/channel/UC9Qa_gXarSmObPX3ooIQZrg/playlists
# https://www.youtube.com/watch?v=vg9cNFPQFqM
# https://www.youtube.com/watch?v=XJKgVLjK3P8
# All of Kate's Beep Beep Boop Boop playlists: https://t.co/ZnF6GJY8qb
# https://drive.google.com/drive/folders/1g0AP75LcEhUIlC4zMOmzdci3JVYEPDen
#
# ~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#
# ~-IT "Morons" and the Security Equation-~
#
# Plane inspiration for Jetpacks, personal Helicopters, etc.
# Just more "Vaccum Cleaner" products, Mr. Hughes...
# Recall Dasyatidae project by Kevin Kloster et. al.
# Telescoping wings mean slower taxi, lower altitude, DRTbox
# Recall Robert L. Forward, Mark R. Tomion, et. al.
# Recall Die Glocke; and Magneto-Hydro-Dynamics...
# Recall Eugene Podklenov; and Ferrofluids in Rodin Coils...
# What's a Caduceus Coil?
# What's an electromagnet?
# What's a generator/dynamo/motor?
# Recall Brown's gas, a.k.a. Hydrogen&Oxygen;HHO;Hydroxy...
# Recall the combustion "engine"/turbine/generator...
# Recall Stan Meyer's dune buggy run on water
# Recall HoneyBadger poject by Feddie, et. al.
# Recall OTT2k9&FranTyers&DML&BayesianStats&SML&ANN...
# Recall De Sitter Manifolds... & wget .pdf?
# Recall Thorium
# Recall Cold Fusion (Frank Znidarsic)
# Recall Turtur (link to YouTube? )
...
# Nickel-Iron-oxide paint, NO 3-WAY RIGHT-ANGLES (RADAR REFLECTOR)
...
./firefox https://en.wikipedia.org/wiki/Drag-reducing_aerospike &
./firefox https://en.wikipedia.org/wiki/Thrust_vectoring &
./firefox https://en.wikipedia.org/wiki/Active_noise_control &
./firefox https://en.wikipedia.org/wiki/VTOL &
./firefox https://en.wikipedia.org/wiki/Vomit-comet &
...
sleep 1
./firefox https://www.terrasailindustries.com/shop/ &
sleep 2
./firefox https://blackhawkparamotor.com/store/product/lowboy-quad-2/ &
sleep 3
...
sleep 8
./firefox http://www.terrasailindustries.com/shop/Bomber-Combo4.html &
sleep 7
./firefox http://blackhawkparamotor.com/kestrel-v4-pro/ &
sleep 5
./firefox http://www.turfdog.co.uk/boards.php &
sleep 3
./firefox https://en.wikipedia.org/wiki/Glider_(sailplane)
rm firefox
echo "All done!"
